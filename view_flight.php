...
<tr><td width="100%"  align="right" bgcolor="#F4F4F4" style="border-bottom:3px #C0C0C0 solid"><p>&nbsp;</p>

  <p><a href="">Email</a>|<a class="example5" href="print_flight_fr.php?fid=<?php echo $fid?>&tripID=<?php echo $tripID?>">print</a></p></td></tr>
...
echo $tripname=$result['group_name'];
              ...
              <tr>
                ...
                <td width="6%" bgcolor="#FFFFFF" >Contacts</td>
              ...
              <tr>
                ...
                <td height="30" colspan="4" bgcolor="#FFFFFF" style="border-bottom:0px #C0C0C0 solid; border-right:0px #C0C0C0 solid; font-size:120%"><p><u>Reservation Reference: <b><?php echo $reservation_ref?></b></u></p></td>
     ...
     <td  style="border-bottom:1px #C0C0C0 solid; border-right:1px #C0C0C0 solid"><?php echo $from?>-<?php echo $to?> <?php if($flight_type==2){ echo '<b>(Return Journey)</b>';}?></td>
...
<tr class="black_text">
     ...
     <td width="13%" height="20" align="left" bgcolor="#d0d0d0" style="color:fff">Visitors list</td>

     <td width="16%" align="left" bgcolor="" style="color:fff">&nbsp;</td>

     <td width="3%" align="left" bgcolor="" style="color:fff">&nbsp;</td>
  ...
  <tr class="black_text">
    ...
    <td height="24" colspan="7" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid" >Full Name</td>

    <td width="26%" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid">Nationality</td>

    <td width="36%" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid">Extra services </td>
...
$sql = mysqli_query($conn,"SELECT * FROM  tbl_flight_pax WHERE flight_id =$flightid GROUP BY visitor_id")or die(mysqli_error($conn)());
 ...
 if($numofrows == 0){?>
  ...
  <tr>
    ...
    <td height="47" colspan="9" align="center" valign="middle" bgcolor="#fff" class="italix">No Visitors on this flight</td>
...
$room_type= $result1['age'];
 ...
 //this means if there is a remainder
  ...
  <tr style="border-bottom:1px #C0C0C0 solid">
    ...
    <td height="37" colspan="7" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $visitor_name?><?php if($age<18 and $age>0){
  ...
  <?php
    ...
    <td height="37" colspan="7" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $v_name?><?php if($age<18 and $age>0){
    ...
    <tr>
      ...
      <td width="39%"><p><?php echo $adults?> Adult(s) <b> <?php echo $currency?>  <?php echo $adultsfare?> </b> p.person</p>
      ...
      <td width="53%"><span style="font-size:130%">Total<?php echo ' ';
	  ...
	  echo $total=$kids*$kidfare+$adults*$adultsfare;?> </span></td>
          ...
          <tr height="30" id="servedby" class="black_text">
               ...
               <td width="8%" height="20"  colspan="" align="left"bgcolor="#333333">Kind Regards: 
