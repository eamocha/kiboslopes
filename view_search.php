...
<div id="mid_content_inner">
  ...
  <span class="header"> <strong>Your Tools</strong></span>
    ...
    <ul id="left_nav_menu">
      ...
      <li style="background:#F0F0F0;"><a title="KIBO SLOPES" href="trips.php"><img src="images/icon2.png" alt="" width="27" height="21" />  Trips</a></li>
...
<form id="DateForm"  name="DateForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"><input name="inputDate" class="inputDate" id="inputDate" value="<?php // =$todates;?>"  placeholder="Search"/> 
...
$trip_sql = mysqli_query($conn,"SELECT  * FROM   tbl_trips WHERE deleted=0")or die(mysqli_error($conn)());
