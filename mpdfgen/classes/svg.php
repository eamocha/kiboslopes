...
/* mPDF 5.0.041 */
	...
	function svgOffset ($attribs): void{
...
function svgDefineTxtStyle($critere_style): void
{
	...
	function svgAddGradient($id,$array_gradient): void{
	...
	function svgWriteString($content): void{
