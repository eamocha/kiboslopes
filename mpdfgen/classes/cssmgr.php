...
function _mergeFullCSS($p, &$t, $tag, $classes, $id): void {
...
function setBorderDominance($prop, $val): void {
...
function _set_mergedCSS(&$m, &$p, $d=true, $bd=false): void {
	if (isset($m)) {
...
function _mergeBorders(&$b, &$a): void {	// Merges $a['BORDER-TOP-STYLE'] to $b['BORDER-TOP'] etc.
