...
var $kerninfo;
	...
	function TTFontFile(): void {
		$this->maxStrLenRead = 200000;	// Maximum size of glyf table to read in as string (otherwise reads each glyph from file)
	}


	function getMetrics($file, $TTCfontID=0, $debug=false, $BMPonly=false, $kerninfo=false, $unAGlyphs=false): void {	// mPDF 5.4.05
	...
	function readTableDirectory($debug=false): void {
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	function extractInfo($debug=false, $BMPonly=false, $kerninfo=false): void {
		$this->panose = array();
		$this->sFamilyClass = 0;
...
//================================================================================
	...
	function getGlyphs($originalGlyphIdx, &$start, &$glyphSet, &$subsetglyphs): void {
		$glyphPos = $this->glyphPos[$originalGlyphIdx];
		$glyphLen = $this->glyphPos[$originalGlyphIdx + 1] - $glyphPos;
		if (!$glyphLen) { 
			return;
	...
	function getHMTX($numberOfHMetrics, $numGlyphs, &$glyphToChar, $scale): void {
	...
	function getLOCA($indexToLocFormat, $numGlyphs): void {
	...
	// CMAP Format 4
	function getCMAP4($unicode_cmap_offset, &$glyphToChar, &$charToGlyph ): void {
		$this->maxUniChar = 0;	
