...
<link href="pagination/css/pagination.css" rel="stylesheet" type="text/css" /><link href="css/styles.css" rel="stylesheet" type="text/css" />
...
for($i = 0; $i<$numofrows; $i++) {
    ...
    if($i % 2) { //this means if there is a remainder
		...
		?>
              ...
              <tr>
                ...
                <td height="37" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo $hotel_name?></td>
                ...
                <td bgcolor="#F0F0F0" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo insertSoftBreak($fax, 20,'<br />');?></td>
       ...
       ?>
              ...
              <tr>
                ...
                <td height="37" bgcolor="#FFF" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo $hotel_name?></td>

                <td bgcolor="#Fff" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo $location?></td>

                <td bgcolor="#Fff" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo  insertSoftBreak($fax, 20,'<br/>');?></td>
	...
	?>
              ...
              <tr>
                ...
                <td height="24" colspan="9" bgcolor="#333" class="white_text">&nbsp;</td>

              </tr>

              <tr>

                <td height="24" colspan="9" bgcolor="#eee" class="white_text"><?php
