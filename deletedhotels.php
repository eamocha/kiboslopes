    ...
    if($i % 2) { //this means if there is a remainder
		...
		?>
              ...
              <tr>
                ...
                <td nowrap="nowrap" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><a class="example5" href="edit_hotel.php?inc=<?php echo $hotel_id?>">Edit</a> | <a href="includes/deletehotel.php?inc=<?php echo $hotel_id?>">Restore</a></td>
       ...
       ?>
              ...
              <tr>
                ...
                <td nowrap="nowrap" bgcolor="#fff" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><a class="example5" href="edit_hotel.php?inc=<?php echo $hotel_id?>">Edit </a>| <a href="includes/deletehotel.php?inc=<?php echo $hotel_id?>">Restore</a></td>
