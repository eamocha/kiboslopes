...
"title_log_in" => "Đăng nhập/Đăng ký",
...
"idx_log_in" => "Vui lòng đăng nhập/đăng ký",
"idx_public_name" => "TƯ VẤN QUẢN TRỊ RỦI RO VÀ XÂY DỰNG HỆ THỐNG KIỂM SOÁT",

//header.php
"hdr_options" => "Lựa chọn",
"hdr_options_submit" => "Bạn hãy lựa chọn và bấm vào 'Lựa chọn'",
...
"evt_mailer" => "mailer",
"evt_private_event" => "Lịch hẹn cá nhân",
...
"evt_notify_eml_list" => "email tách biệt bằng dấu chấm phảy - tối đa. 255 ký tự.",
...
"evt_url_format" => "link tới website: url or url [name]. E.g. www.google.com [search]",
