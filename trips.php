...
<div id="center_pane_big"><table width="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     <tr>
        ...
        <td width="100" height="62" align="left" valign="top" bgcolor="#F4F4F4" style="border-bottom:1px solid #D9D9D9"><ul id="menu_settings">
...
$numofrows = mysqli_num_rows($trip_sql);
 ...
 if($numofrows == 0){?>
            ...
            <td height="20" colspan="6" align="center" valign="middle" bgcolor="#fff" class="italix">No Trips on using that criteria<?php //$todates?>!</td>
...
for($i = 0; $i<$numofrows; $i++) {
    ...
    <?php echo $group_name?>
      ...
      <br /></td><td ><?php if($no_of_visitors==0){
    ...
    <td class="alt_row2"><?php echo $arrival_date?></td>
    ...
    <td ><a href="view_trip.php?inc=<?php echo $trip_id?>">Details</a> | <a href="includes/cancel_trip.php?inc=<?php echo $trip_id?>">Cancel</a></td>
       ...
       ?> <tr class="alt_row1">
            ...
            <td >
              ...
              <?php echo $group_name?><br /></td> <td ><?php if($no_of_visitors==0){
