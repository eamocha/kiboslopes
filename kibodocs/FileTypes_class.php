    ...
    class FileTypes_class
    {
        ...
        */
        function add($data)
        {
            ...
            $result = mysqli_query($conn,$query) or die ('Failed to save filetypes: ' . mysqli_error($conn)());
            return TRUE;
        }
        ...
        */
        function save($data)
        {
            ...
            $result = mysqli_query($conn,$query) or die('Failed to un-set filetypes active values: ' . mysqli_error($conn)());
            if (isset($data['types'])) {
        ...
        */
        ...
        function delete($data)
        {
            foreach($data['types'] as $id)
            {
                ...
                $result = mysqli_query($conn,$query) or die('Failed to delete filetype: ' . mysqli_error($conn)());
            }
            return TRUE;
        }
    }
