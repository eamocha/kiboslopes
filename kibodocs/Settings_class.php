    ...
    class Settings
    {
        ...
        */
        function save($data)
        {
            foreach ($data as $key=>$value)
            {
                ...
                $result = mysqli_query($conn,$query) or die ('Failed to save settings: ' . mysqli_error($conn)());
            }
            return TRUE;
        }
        /*
        ...
        */
        ...
        function getUserIdNums()
        {
            ...
            $result = mysqli_query($conn,$query) or die('Failed to read user names for settings: ' . mysqli_error($conn)());
