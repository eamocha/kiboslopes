...
<script type="text/javascript">
    ...
    function loadItem(select_box)
    {
        ...
        $result = mysqli_query($conn,$query, $GLOBALS['connection']) or die('Error in query'. mysqli_error($conn)());
...
function getAllUsers()
{
    ...
    $lresult = mysqli_query($conn,$lquery) or die(msg('error'). ':'. $lquery . mysqli_error($conn)());
