...
if( !defined('UserPermission_class') )
{
	...
	{	
		...
		$result = mysqli_query($conn,$query, $this->connection) or die('Unable to query: ' . $query . 'Error: ' . mysqli_error($conn)());
        ...
        function getViewableFileIds()
        {
            ...
            $result = mysqli_query($conn,$query, $this->connection) or die('Unable to query: ' . $query .
