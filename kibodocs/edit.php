...
if (!isset($_REQUEST['submit'])) {
    ...
    // update category
    $filedata->setCategory(mysqli_real_escape_string($conn,$_REQUEST['category']));
    $filedata->setDescription(mysqli_real_escape_string($conn,$_REQUEST['description']));
    $filedata->setComment(mysqli_real_escape_string($conn,$_REQUEST['comment']));
    if (isset($_REQUEST['file_owner'])) {
        $filedata->setOwner(mysqli_real_escape_string($conn,$_REQUEST['file_owner']));
    }
    if (isset($_REQUEST['file_department'])) {
        $filedata->setDepartment(mysqli_real_escape_string($conn,$_REQUEST['file_department']));
    }
