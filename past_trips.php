...
$five_d=strtotime($todates)-5*86400;

$da= date("Y-m-d",$five_d);
...
<div id="mid_content_inner">
  ...
  <span class="header"> <strong>Your Tools</strong></span>
    ...
    <ul id="left_nav_menu">
      ...
      <li style="background:#F0F0F0;"> <a title="KIBO SLOPES" href="past_trips.php"><img src="images/icon2.png" alt="" width="27" height="21"  />Past Trips</a></li>
...
$trip_sql = mysqli_query($conn,"SELECT  * FROM   tbl_trips WHERE group_name like '%$gname%' and deleted=0  and archived=0 and DATE(dep_date)<='$yesterday' order by $orderby desc ")or die(mysqli_error($conn)());
...
for($i = 0; $i<$numofrows; $i++) {
    ...
    <td nowrap="nowrap" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#76B853 1px solid; border-right:#76B853 1px solid"><a href="view_trip.php?inc=<?php echo $trip_id?>">View Details</a>| <a href="includes/archive_trips.php?inc=<?php echo $trip_id?>">Archive</a></td>
	...
	?>
            ...
            <td nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#76B853 1px solid; border-right:#76B853 1px solid"><a href="view_trip.php?inc=<?php echo $trip_id?>">View Details</a>| <a href="includes/archive_trips.php?inc=<?php echo $trip_id?>">Archive</a></td>
...
$trip_sql = mysqli_query($conn,"SELECT   * FROM tbl_trips where deleted=0 and archived=0 and DATE(dep_date)<='$yesterday' ORDER BY trip_id desc LIMIT {$startpoint} , {$limit} " )or die(mysqli_error($conn)());
