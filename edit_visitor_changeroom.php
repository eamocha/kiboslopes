...
<body><form id="MyForm"  name="MyForm" class="formular" method="post" action="edit_visitor_changeroom_exec.php?inc=<?php echo $tripID?>">
...
echo $r['group_name'];?></td>
      ...
      <tr>
        ...
        <input name="pptdetails" type="text"  class="validate[optional] text-input" id="pptdetails" value="<?php echo $pp_details;?>" size="30" /></td>
...

{
	...
	document.getElementById('v2name').style.display='block';
	 ...
	 document.getElementById('v2name').style.display='none';

	   document.getElementById('v2ppdetails').style.display='none';

	    document.getElementById('v2address').style.display='none';

		 document.getElementById('v2insurance').style.display='none';

		  document.getElementById('v2nationality').style.display='none';

		  	  document.getElementById('v2age').style.display='none';
