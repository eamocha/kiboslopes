...
<div id="center_pane_big"><table width="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <div id="sub_menu_icon"><img src="images/report_icon_settings.png" alt=""  border="0" /></div>                <ul>
                  ...
                  <li><a class='example5' href="print_hotel_report.php?inc=<?php echo $tripID?>&hot=<?php echo $trip_hotel?>" title="print">Print Voucher</a></li>
...
while($reservation_result=mysqli_fetch_array($reservation)){
  ...
  $dates[]=strtotime($reservation_result['date']);
	...
	/* $comments[]=$reservation_result['voucher_remarks'];$booking_terms[]=$reservation_result['booking'];	
...
//end while?> </td>
            ...
            <td bgcolor="#FFFFFF" style="border-bottom:1px #C0C0C0 solid" ><ul><li></li><a style=" text-align:left; float:right; clear:both" href="javascript:popup('addcomment.php?inc=<?php echo $tripID?>&hot=<?php echo $trip_hotel?>')">Add</a></ul></td>
...
?>
          ...
          <tr class="black_text">
            ...
            <td width="14%" height="24" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid" >&nbsp;</td>
...
//this means if there is a remainder
    ...
    if($room_type!=''|| $room_type!='Single'){
       ...
       <tr>
         ...
         <td colspan="9" bgcolor="#fff" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"> 
