...
try
{
  ...
  $sql="INSERT INTO tbl_itinerary (`date`,`title`,`details`,`trip_id`,`hotel_id`,`deleted`,`remarks`,singles,`doubles`,`twins`,`triples`,`child_beds`) 
  		 VALUES(?,?,?,?,?,?,?,?,?,?,?,?)"; 
  /* Prepare statement */
		...
		$stmt->bind_param('sssiiisiiiii',$indate,$day,$itnedetails,$tripid,$hotel,$deleted,$spreqs,$singles,$doubles,$twins,$triples,$child_beds);
