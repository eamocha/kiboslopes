          ...
          <li>
            ...
            <ul>
             <li>
                  ...
                  <li><a title="Kiboslopes" target="_blank" href="print_hotel_html.php?inc=<?php echo $tripID?>&hot=<?php echo $trip_hotel?>&f_name=<?php echo $fullName;?>">Print Booking Voucher</a></li>
             ...
             <li>
                  ...
                  <li><a href="print_hotel_pdf.php?inc=<?php echo $tripID?>&hot=<?php echo $trip_hotel?>&f_name=<?php echo $fullName;?>" title="print">Download Voucher in PDF</a></li>
                  ...
                  <li><a  class="example5" href="print_hotel.php?inc=<?php echo $tripID?>&hot=<?php echo $trip_hotel?>&f_name=<?php echo $fullName;?>" title="print">View Booking Voucher</a></li>
      ...
      <tr>
        ...
        <td height="30" colspan="3" align="center" valign="middle" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">
          ...
          <tr class="black_text">
            ...
            <td height="75" colspan="12" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" ><table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" style="border:#CCC 1px solid;">
...
echo $typ;?></strong></u></span></td>
          ...
          <tr class="black_text">
            ...
            <td height="33" colspan="12" bgcolor="#FFFFFF" style="border-bottom:1px #C0C0C0 solid" >Kindly <?php echo $mes;?> under this reference<b> 
          ...
          <tr class="black_text">
            ...
            <td height="20" colspan="12" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" ><strong>Reservation Details</strong></td>
          ...
          <tr class="black_text">
            ...
            <td colspan="6" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid; text-align: center;">Type of Rooms</td>
          ...
          <tr class="black_text">
            ...
            <td width="4%" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid;font-size:80%">F. Rm</td>
...
<tr class="black_text">
            ...
            <td height="20" colspan="8" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" >&nbsp;</td>
          ...
          <tr class="black_text">
            ...
            <td colspan="10" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid">RoomType</td>

            </tr>

  <?php  
//check if there are visitors selected for the hotel
$strSelectedVisitors = "SELECT *  FROM (SELECT v.visitor_name AS visitorname,vi.room_type AS roomtype FROM tbl_visitors v INNER JOIN tbl_visitor_itenerary vi ON v.visitor_id=vi.visitor_ref_id WHERE vi.visitor_type='v' AND v.deleted=0 AND vi.deleted=0 AND vi.itenerary_id=$itinerary_id
UNION
SELECT s.v_name AS visitorname,vi.room_type AS roomtype FROM tbl_sharing s INNER JOIN tbl_visitor_itenerary vi ON s.sharing_id=vi.visitor_ref_id WHERE vi.visitor_type='s' AND s.deleted=0 AND vi.deleted=0 AND vi.itenerary_id=$itinerary_id) A ORDER BY roomtype";

$resultVisitor_Itenerary = mysqli_query($conn,$strSelectedVisitors);


if(mysqli_num_rows($resultVisitor_Itenerary)>0)//selected visitors exist
{
	
	//put the code here
	$intSelectedVisitors = 0;
	$strBgColor="";
	while($rowSelectedVisitors = mysqli_fetch_object($resultVisitor_Itenerary)){
		
		if($intSelectedVisitors%2==0)
		{
			$strBgColor="#FFFFFF";
		}
		else
		...
		?>
		<tr>
			<td height="20" bgcolor="<?php echo $strBgColor;?>" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">-</td>
			<td height="20" bgcolor="<?php echo $strBgColor;?>" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo $rowSelectedVisitors->visitorname?></td>
			<td bgcolor="<?php echo $strBgColor;?>" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo $rowSelectedVisitors->roomtype?></td>
			<td colspan="10" bgcolor="<?php echo $strBgColor;?>" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">&nbsp;</td>
		</tr>
		<?php
	}
...
else //if no visitor exist in the selected visitors list
{


$visitor_sql = mysqli_query($conn,"SELECT * FROM  tbl_visitors WHERE trip_id = $tripID and deleted=0")or die(mysqli_error($conn)());
...
$numofrows = mysqli_num_rows($visitor_sql);
 ...
 if($numofrows == 0){?>
            ...
            <td height="47" colspan="12" align="center" valign="middle" bgcolor="#fff" class="italix">To follow later!</td>
...
//this means if there is a remainder
    ...
    <td colspan="10" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo $room_type?></td>
    ...
    if($room_type!=''|| $room_type!='Single'){
       ...
       <tr>
         ...
         <td colspan="10" bgcolor="#fff" class="white_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"> 
	...
	?>   
            ...
            <tr class="black_text">
              ...
              <td height="25" colspan="12" bgcolor="#FFFFFF" style="border-bottom:1px #C0C0C0 solid" ><table cellspacing="0" cellpadding="0">
            ...
            <tr height="30" id="servedby" class="black_text">
               ...
               <td height="20"  colspan="10" align="left"bgcolor="#333333">Kind Regards: 
