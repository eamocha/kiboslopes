...
$(document).ready(function(){
  ...
  var bal=$("#bal_due").val();
   ...
   var new_bal=parseFloat(x) * parseFloat(y)+bal;

   $("#bal_due").html(new_bal);
 ...
 var a= $("#st3").html(x*y);
  ...
  $("#amt4").change(function(){
   ...
   var new_bal=parseFloat(x) * parseFloat(y)+parseFloat(bal);
   ...
   $(".prices").change(function(){
	  ...
	  var x1=$("#amt1").html()*$("#singles").html();

	  var x2=$("#st2").html()*$("#twins").html();

	  var x3=$("#st3").html()*$("#doubles").html();

	  var x4=$("#st4").html()*$("#triples").html();

	  var x5=$("#st5").html()*$("#child_beds").html();

	  var x6=$("#st6").html()*$("#others").html();

	  var sbt=$("#subtt").html();



	  var stotal=parseInt(sbt)+parseInt(x1)+parseInt(x2)+parseInt(x3)+parseInt(x4)+parseInt(x5)+parseInt(x6);/*+parseFloat(x2)+parseFloat(x3)+parseFloat(x4)+parseFloat(x5);*/
...
">Add payment details </td>
  ...
  <tr>
    ...
    <td class="td_format" align="right"  valign="bottom"> <input name="st1" type="text"  class="text-input prices" readonly="readonly" id="st1" value="0" size="10" /></td>
  ...
  <tr>
    ...
    <td class="td_format" align="right" valign="bottom"><input name="st2" type="text"  class="text-input prices" readonly="readonly" id="st2" value="0" size="10" /></td>
  ...
  <tr>
    ...
    <td class="td_format" align="right" valign="bottom"><input name="st3" type="text"  class="text-input prices" readonly="readonly" id="st3" value="0" size="10" /></td>
  ...
  <tr>
    ...
    <td class="td_format" align="right" valign="bottom"><input name="st4" type="text"  class="text-input prices" readonly="readonly" id="st4" value="0" size="10" /></td>
  ...
  <tr>
    ...
    <td class="td_format" align="right" valign="bottom"><input name="st5" type="text"  class="text-input prices" readonly="readonly" id="st5" value="0" size="10" /></td>
  ...
  <tr>
    ...
    <td class="td_format" align="right"><input name="st6" type="text"  class="text-input prices" readonly="readonly" id="st6" value="0" size="10" /></td>
