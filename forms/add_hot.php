...
<body><form id="flight"  name="flight" class="formular" method="post" action="forms/insert_hot.php" ><table width="450px" border="0" align="right" cellpadding="8" cellspacing="0">
