...
$sql = mysqli_query($conn,"SELECT * FROM  tbl_accounts WHERE account_id = $imp AND deleted=0 ")or die(mysqli_error($conn)());
...
<body><form id="imprest"  name="imprest" class="formular" method="post" action="edit_imprest_exec.php?inc=<?php echo $tripID?>&imp=<?php echo $account_id?>"><table width="450px" border="0" align="right" cellpadding="8" cellspacing="0">
...
">Add New Vehicle  Details</td>
      ...
      <tr>
        ...
        <td height="35" align="left" bgcolor="#FFFFFF">Date <br />
          ...
          <input name="dates"  class="validate[required] text-input" type="text" id="dates" value="<?php echo $date?>" size="30" /></td>

        <td align="left" bgcolor="#FFFFFF">Payment To:<br />

          <input name="receiver"  class=" text-input" type="text" id="receiever" value="<?php echo $reciever?>" size="30" /></td>

        <td align="left" bgcolor="#FFFFFF">Currency<br /><input type="text"  class="validate[required] text-input" id="currency" name="currency" value="<?php echo $currency?>" size="5" /></td>

        <td align="left" bgcolor="#FFFFFF">Amount 

          <input name="amount"  class="validate[required] text-input" type="text" id="amount" value="<?php echo $amount?>" size="15" /></td>
      ...
      <tr>
        ...
        <td align="left" bgcolor="#FFFFFF">Reference<br />
          ...
          <input name="ref"  class="validate[required] text-input" type="text" id="ref" value="<?php echo $ref?>" size="30" /></td>
      ...
      <tr>
        ...
        <td height="35" align="left" bgcolor="#FFFFFF">Particulars<br /><textarea id="particulars" class="validate[required]" name="particulars"><?php echo $particulars?></textarea></td>
