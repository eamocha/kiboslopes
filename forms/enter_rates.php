...
">Input hotel rates <?php 
  ...
  <input name="amount_payable"  type="text" readonly="readonly" style="border:none"  class="text-input" id="amount_payable" value="<?php echo $tt_payable?>" size="10" />
      ...
      <tr  id="servedby" class="italix">
        ...
        <td height="20" colspan="2" align="center" bgcolor="#333333">Served By: <?php echo $_SESSION['f_name'];?>
