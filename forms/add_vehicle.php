...
<form id="addvehicle"  name="addvehicle" class="formular" method="post" action="add_veh_exec.php"><table width="450px" border="0" align="right" cellpadding="8" cellspacing="0">
...
">Add New Vehicle  Details</td>
      ...
      <tr>
        ...
        <input name="capacity" type="text"  class="validate[required,custom[onlyNumber]] text-input" id="capacity" value="" size="30" /></td>

        <td align="left" bgcolor="#FFFFFF">Other details<br />

          <input name="description" type="text"  class="text-input" id="description" value="" size="30" /></td>
