...
<body><form id="MyForm"  name="MyForm" class="formular" method="post"   action="hire_company_exec.php">
...
">Car Hire Details</td>
      ...
      <tr><td height="35" align="left" bgcolor="#FFFFFF">Vehicle Code: <br />
          ...
          <input name="vehcode" type="text"  class="validate[required] text-input" id="vehcode" value="" size="30" /></td>

        <td align="left" bgcolor="#FFFFFF">Capacity<br />

        <input name="capacity" type="text"  class=" text-input" id="capacity" value="" size="30" /></td>

        <td align="left" bgcolor="#FFFFFF">Company Name<br />

        <input name="company_name" type="text"  class="text-input" id="company_name" value="" size="30" /></td>

        </tr><tr>

          <td height="35" align="left" bgcolor="#FFFFFF">Fax<br />

          <input name="fax" type="text"  class="text-input" id="fax" value="" size="30" /></td>

        <td align="left" bgcolor="#FFFFFF">phone<br />

        <input name="phone" type="text"  class="text-input" id="phone" value="" size="30" /></td>

        <td align="left" bgcolor="#FFFFFF">Comments<br />

        <input name="Comments" type="text"  class="text-input" id="Comments" value="" size="30" /></td></tr>
