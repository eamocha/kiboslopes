	...
	if($numofrows<0)
	 ...
	 echo '<b>no assigned</b> ';
          ...
          <tr class="black_text">
            ...
            <td height="19" colspan="5" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" >:
              <?php
 ...
 $numofrows=mysqli_num_rows($sql);
  ...
  while($result= mysqli_fetch_array($sql)){
	...
	?></td>
            ...
            <td height="50" colspan="10"  style="border-bottom:1px #C0C0C0 solid" ><?php echo 	$spreqs?></td>
            </tr>
...
echo $status  = $result['status']; }?></td>
	...
	?> <tr class="black_text" style="border-top:2px #eded11 solid" bordercolor="#ff6600">
              ...
              <td height="25" colspan="14" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" >&nbsp;</td>
            ...
            <td height="33" colspan="2" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" >&nbsp;</td>
             ...
             <td height="75" colspan="14" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" ><table width="95%" border="0" align="right" cellpadding="5" cellspacing="1" style=" border:#CCC 1px solid;">
