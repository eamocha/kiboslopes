...
echo $typ;?></strong></u></span></td>
          ...
          <tr class="black_text">
            ...
            <td height="33" colspan="11" bgcolor="#FFFFFF" style="border-bottom:1px #C0C0C0 solid" >Kindly <?php echo $mes;?> accomodation under reference<b> 
          ...
          <tr class="black_text">
            ...
            <td height="20" colspan="9" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" ><strong>Reservation Details: <?php echo $strCheckInCheckOutDate;?></strong></td>
          ...
          <tr class="black_text">
            ...
            <td width="6%" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid;font-size:80%">Family</td>
...
?>
          ...
          <tr class="black_text">
            ...
            <td colspan="6" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" >&nbsp;</td>
          ...
          <tr class="black_text">
            ...
            <td colspan="8" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid">&nbsp;</td>

            </tr>

<?php  
//Put option for when rooms have been selected, otherwise just use the whole list as it is

//$strSelectedVisitors = "SELECT * FROM tbl_visitor_itenerary WHERE itenerary_id=".$itineray_id." AND deleted=0";

$strSelectedVisitors = "SELECT *  FROM (SELECT v.visitor_name AS visitorname,vi.room_type AS roomtype FROM tbl_visitors v INNER JOIN tbl_visitor_itenerary vi ON v.visitor_id=vi.visitor_ref_id WHERE vi.visitor_type='v' AND v.deleted=0 AND vi.deleted=0 AND vi.itenerary_id=$itineray_id
UNION
SELECT s.v_name AS visitorname,vi.room_type AS roomtype FROM tbl_sharing s INNER JOIN tbl_visitor_itenerary vi ON s.sharing_id=vi.visitor_ref_id WHERE vi.visitor_type='s' AND s.deleted=0 AND vi.deleted=0 AND vi.itenerary_id=$itineray_id) A ORDER BY roomtype";
...
$intSelectedVisitors++;	
	...
	<tr>
		...
		<td colspan="8" bgcolor="<?php echo $strBgColor;?>" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">&nbsp;</td>
	</tr>
	<?php
}

}
else //no selelected visitors, use general list
{
...
//this means if there is a remainder
    ...
    <td colspan="8" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">&nbsp;</td>
    ...
    if($room_type!=''|| $room_type!='Single'){
       ...
       <tr>
         ...
         <td height="20" bgcolor="#FFFFFF"  style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><?php echo $sharing_with?></td>

         <td height="20" bgcolor="#FFFFFF"  style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">
         ...
         <td bgcolor="#FFFFFF" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"> 

           <?php echo $room_type?>

         </td>

         <td colspan="8" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">&nbsp;</td>
