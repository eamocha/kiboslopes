...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			rowFilter: ' ',
			colFilter: ' ',
			colors: ['#e9e744','#26a4ed','#92d5ea','#ee8310','#8d10ee','#5a3b16','#666699','#f45a90','#be1e2d'],
			...
			barGroupMargin: 30,
			barMargin: 3, //space around bars in bar chart (added to both sides of bar)
			yLabelInterval: 10 //distance between y labels
		},options);
