...
<iframe name="theiframe" id="theiframe" width="100%" height="100%" src="print_hotel_payment.php?inc=<?php echo $tripID?>&hot=<?php echo $trip_hotel?>&f_name=<?php echo $fullName?>"></iframe>
