      ...
      <tr>
        ...
        <td height="30" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style=" ">
          ...
          <tr class="black_text">
            ...
            <td height="75" colspan="4" rowspan="3" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" ><table width="100%" border="0" align="left" cellpadding="5" cellspacing="0" style="border:#CCC 1px solid; ">
...
<?php if($no_of_visitors==0){
            ...
            <td rowspan="4" style="border-bottom:1px #C0C0C0 solid;"><div class="rot-pos-90"><?php echo $group_name?></div></td>

            </tr>

          <tr class="black_text">

            <td height="75" colspan="4" bgcolor="#F0F0F0" style="border-bottom:0px #C0C0C0 solid" align="right" >Vehicle:</td>

            <td height="75" colspan="6" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" ><?php 
	...
	if($numofrows<0)
	 ...
	 echo '<b>no assigned</b> ';
          ...
          <tr class="black_text">
            ...
            <td height="75" colspan="4" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" align="right" >Driver</td>

            <td height="75" colspan="6" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" >:
              <?php
 ...
 $numofrows=mysqli_num_rows($sql);
  ...
  while($result= mysqli_fetch_array($sql)){
	...
	?></td>
            ...
            <td height="50" colspan="11"  style="border-bottom:1px #C0C0C0 solid" ><?php echo 	$spreqs?></td>
            </tr>

            <tr class="black_text">

            <td height="33" colspan="4" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" ><strong>Itinerary List</strong></td>
            ...
            <td colspan="3" rowspan="2" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid" >Itinerary</td>
            ...
            <td colspan="6" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid" align="center">Rooming</td>
            ...
            <tr class="black_text">
              ...
              <td width="2%" nowrap="nowrap" align="center"  bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid;border-right:1px #eaeaea solid">Sin</td>

              <td width="3%" nowrap="nowrap" align="center"  bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid;border-right:1px #eaeaea solid">Twn</td>

              <td width="2%" nowrap="nowrap" align="center"  bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid;border-right:1px #eaeaea solid">Dbl</td>

              <td width="2%" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid;border-right:1px #eaeaea solid">Trp</td>
              <td width="2%" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid;border-right:1px #eaeaea solid">FMr</td>
...
$child_beds=$result['child_beds'];
    ...
    <td height="37" colspan="3" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid; padding-left:2px;">
...
$status  = $result['status'];
    ...
    <td nowrap="nowrap"bgcolor="#F0F0F0" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid; word-break: break-all;"><div style="width:100%; white-space:normal"><?php echo $comments?></div></td>
       ...
       ?> <tr>
            ...
            <td height="37" colspan="3" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid; padding-left:2px;">
...
<td height="33" colspan="15" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" ><strong>Visitors List</strong></td>

</tr>

<tr class="black_text">

<td height="24" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid" >No.</td>
...
<td colspan="3" nowrap="nowrap" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid">Nationality</td>

<td colspan="3" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid">Room</td>
<td colspan="3" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid">Age</td>
...
<td height="47" colspan="15" align="center" valign="middle" bgcolor="#fff" class="italix">Awaiting visitor details</td>
...
<td height="37" bgcolor="#FaFaFa" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"> <?php echo $visitornumber;?>.</td>
<td height="37" colspan="3" bgcolor="#FaFaFa" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $visitor_name?><?php if($age<18 and $age>0){
echo '-('.$age.'years)'; }?><br /></td>
<td colspan="2" bgcolor="#FaFaFa" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $passport_details?></td>
<td colspan="3" bgcolor="#FaFaFa" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $nationality?></td>
<td colspan="3" nowrap="nowrap" bgcolor="#FaFaFa" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $room_type?></td>
<td colspan="3" nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php $age==0? $age="": $age=$age;  echo $age;?></td>
</tr>
<?php
...
$home_address=$share_q['home_address'];
 ...
 ?>  
<tr id="share">
<td height="37" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $visitornumber //$sharing_with?>.<br /></td>
...
<td colspan="2" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $pp_details?></td>
<td colspan="3" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $nation?></td>
<td colspan="3" nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $room_type?></td>
<td colspan="3" nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php $age==0? $age="": $age=$age;  echo $age;?></td>
</tr>
...
?>   
  ...
  <tr class="black_text" style="border-top:2px #eded11 solid" bordercolor="#ff6600">
            ...
            <td height="33" colspan="4" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" ><strong>Flights</strong></td>
