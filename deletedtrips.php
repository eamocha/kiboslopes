...
<div id="mid_content_inner">
  ...
  <span class="header"> <strong>Your Tools</strong></span>
    ...
    <ul id="left_nav_menu">
      ...
      <li style="background:#F0F0F0;"> <a title="KIBO SLOPES" href="deletedtrips.php"><img src="images/icon2.png" alt="" width="27" height="21"  />Deleted Trips</a></li>
      ...
      <tr>
        ...
        <td height="30" colspan="3" align="center" valign="middle" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
          ...
          <tr class="black_text">
            ...
            <td width="42%" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid" ><strong>Group Name</strong></td><td width="3%" height="24" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid" ><strong>No</strong></td>

            <td width="16%" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid"><strong>Arrival</strong></td>
...
$trip_sql = mysqli_query($conn,"SELECT   * FROM tbl_trips where deleted=1 ORDER BY trip_id desc LIMIT {$startpoint} , {$limit} " )or die(mysqli_error($conn)());
...
for($i = 0; $i<$numofrows; $i++) {
    ...
    <td nowrap="nowrap" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><a href="view_trip.php?inc=<?php echo $trip_id?>">View Details</a>|<span class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"> <a href="includes/restore_trip.php?inc=<?php echo $trip_id?>">Restore</a></span></td>
	...
	?>
            ...
            <td nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><a href="view_trip.php?inc=<?php echo $trip_id?>">View Details</a>| <a href="includes/restore_trip.php?inc=<?php echo $trip_id?>">Restore</a></td>
	...
	?>
          ...
          <tr>
            ...
            <td height="24" colspan="6" bgcolor="#fff" class="white_text"><?php
			        ...
			        $statement = "`tbl_trips` where `deleted` = 1";
