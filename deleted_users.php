...
<li><a class='example5'  title="KIBO SLOPES" href="settings.php">Settings</a></li>

<li><a class=''  title="KIBO SLOPES" href="hotel.php">Hotels</a></li>

<li><a class=''  title="KIBO SLOPES" href="hotel.php">Deleted Users</a></li>
...
$sql = mysqli_query($conn,"SELECT   * FROM tbl_users where deleted=1")or die(mysqli_error($conn)());
...
for($i = 0; $i<$numofrows; $i++) {
  ...
  ?></td>
    ...
    <td nowrap="nowrap" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><a href="includes/restore_user.php?user=<?php echo $user_id?>"> Restore</a></td>
  ...
  ?></td>
	...
	?>
            ...
            <td nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid"><a  href="includes/restore_user.php?user=<?php echo $user_id?>">Restore</a></td>
