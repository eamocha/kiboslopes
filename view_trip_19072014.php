...
<?php if($no_of_visitors==0){
            ...
            <td height="75" colspan="5" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" >T/L:<strong>
...
<?php echo $team_leader?>
          ...
          <tr class="black_text">
            ...
            <td height="38" colspan="4" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" ><?php 
	...
	if($numofrows<0)
	 ...
	 echo '<b>no assigned</b> ';
          ...
          <tr class="black_text">
            ...
            <td height="19" colspan="4" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" ><?php
 ...
 $numofrows=mysqli_num_rows($sql);
  ...
  while($result= mysqli_fetch_array($sql)){
	...
	?></td>
            ...
            <td height="50" colspan="5" bgcolor="#Eee" style="border-bottom:1px #C0C0C0 solid" ><strong>Special Requirements:</strong></td>
...
echo $status  = $result['status']; }?></td>
	...
	?> <tr class="black_text" style="border-top:2px #eded11 solid" bordercolor="#ff6600">
            ...
            <td height="33" colspan="16" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" ><strong>Visitors List</strong></td>
          ...
          <tr class="black_text">
            ...
            <td colspan="3" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid">Insurance</td>
...
$numofrows = mysqli_num_rows($sql);
 ...
 if($numofrows == 0){?>
            ...
            <td height="47" colspan="16" align="center" valign="middle" bgcolor="#fff" class="italix">No Visitors on this trip</td>
...
for($i = 0; $i<$numofrows; $i++) {
  ...
  //this means if there is a remainder
    ...
    <td colspan="3" nowrap="nowrap" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $insurance?></td>
    ...
    if($room_type!=''|| $room_type!='Single'){
         ...
         <br /></td>
		  ...
		  echo '-('.$age.'years)'; }?>
            ...
            <td colspan="3" nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><?php echo $insurance_details?></td>
            ...
            <td nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#c0c0c0 1px solid; border-right:#EAEAEA 1px solid"><a class="example5" href="edit_shared.php?inc=<?php echo $visitor_id?>&amp;tripid=<?php echo $tripID?>&amp;share_id=<?php echo $sharing_id?>">Edit </a> | <a class="example5" href="edit_visitor_changeroom.php?inc=<?php echo $visitor_id?>&amp;tripid=<?php echo $tripID?>&amp;share_id=<?php echo $sharing_id?>">Change Room</a> | <a href="includes/delete_sharing_visitor.php?inc=<?php echo $visitor_id?>&amp;tripid=<?php echo $tripID?>&amp;share_id=<?php echo $sharing_id?>">Delete</a></td>
	...
	?>   
          ...
          <tr class="black_text">
            ...
            <td height="33" colspan="2" bgcolor="#E1E1E1" style="border-bottom:1px #C0C0C0 solid" >&nbsp;</td>
             ...
             <td height="75" colspan="16" bgcolor="#F0F0F0" style="border-bottom:1px #C0C0C0 solid" ><table width="95%" border="0" align="right" cellpadding="5" cellspacing="1" style="border:#CCC 1px solid;">
