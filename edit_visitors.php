...
$(document).ready(function(){
			...
			//display based on values available
			
			checkroom('<?php echo $room_type;?>');
...
function checkroom(val)
{
		...
		if(val=="Double"||val=="Twin"){
			...
			$('#v2name').style.display='block';
			
			$('#v2ppdetails').style.display='block';
			
			$('#v2address').style.display='block';
			
			$('#v2insurance').style.display='block';
			
			$('#v2nationality').style.display='block';
			
			$('#v2age').style.display='block';
			
			$('#v3name').style.display='none';
			
			$('#v3ppdetails').style.display='none';
			
			$('#v3address').style.display='none';
			
			$('#v3insurance').style.display='none';
			
			$('#v3nationality').style.display='none';
			
			$('#v3age').style.display='none';
			...
			$('#v3name').style.display='block';
			
		    $('#v3ppdetails').style.display='block';
			
			$('#v3address').style.display='block';
			
			$('#v3insurance').style.display='block';
			
			$('#v3nationality').style.display='block';
			
			$('#v3age').style.display='block';
			
		 }
			
		 else{
			
		   $('#v2name').style.display='none';
			
		   $('#v2ppdetails').style.display='none';
			
		   $('#v2address').style.display='none';
			
		   $('#v2insurance').style.display='none';
			
		   $('#v2nationality').style.display='none';
			
		   $('#v2age').style.display='none';
...
<body><form id="MyForm"  name="MyForm" class="formular" method="post" action="edit_visitors_exec.php?inc=<?php echo $tripID?>&visitid=<?php echo $visitorid;?>">
...
">Change Visitor  Details for: <?php $trp_name=mysqli_query($conn,"select group_name from tbl_trips where trip_id=$tripID") or die(mysqli_error($conn)());
...
echo $r['group_name'];?></td>
      ...
      <tr>
        ...
        <input name="pptdetails" type="text"  class="validate[optional] text-input" id="pptdetails" value="<?php echo $passport_details;?>" size="30" /></td>
      ...
      <tr>
        ...
        <input name="age" type="text"  class="validate[required,custom[number]] text-input" id="age" value="<?php echo $age?>" size="5" /></td>
        ...
        <td width="114" align="left" bgcolor="#FFFFFF">Room Type<br />
          ...
          <select name="room" id="room"  style="height:auto" class="validate[required] text-input"  onchange='checkroom(this.value)'>
...
<tr >
    ...
    <tr>
      ...
      <span id="v3name" style='display:none'>V3. Name <input name="v3_name" type="text"  class="validate[optional, custom[onlyLetterSp]] text-input" id="v3_name" value="" size="30" data-prompt-position="topLeft:-20" /></span></td>
        ...
        <input name="v3_haddress" type="text"  class=" text-input" id="v3_haddress2" value="" size="30" /></span>
...
<input name="v3_pptdetails" type="text" class="validate[optional] text-input" id="v3_pptdetails" value="" size="30" /></span> </td>
        ...
        <td height="35" align="left"><span id="v3age" style='display:none'>v3 Age<br />

        <input name="v3_age" type="text"  class="validate[optional,custom[number]] text-input" id="v3_age" value="" size="5" /></span></td>

        <td height="35" align="left">&nbsp;</td>

        <td height="35" colspan="3" align="left"><input name="share_id" type="hidden" id="share_id" value="<?php echo $share_id;?>" />          <input type="submit" name="button" id="button" value="  Save " /></td>
