...
<div id="center_pane_big"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li><a class='example5' href="forms/add_imprest.php" title="KAMPS" style="padding-left:25px;">Add New Trip</a></li>
      ...
      <tr>
        ...
        <td height="30" colspan="3" align="center" valign="middle" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
          ...
          <tr class="black_text">
            ...
            <td width="14%" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid" ><strong>Date</strong></td>

            <td width="17%" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid"><strong>Amount</strong></td>

            <td width="17%" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid"><strong>Description</strong></td>

            <td width="17%" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid"><strong>Paid to</strong></td>

            <td width="17%" bgcolor="#F0F0F0" style="border-bottom:3px #C0C0C0 solid"><strong>Status</strong></td>
  ...
  <tr>
    ...
    <td nowrap="nowrap" bgcolor="#F0F0F0" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="2" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">&nbsp;</td>

            <td nowrap="nowrap" bgcolor="#FFFFFF" class="black_text" style="border-bottom:#EAEAEA 1px solid; border-right:#EAEAEA 1px solid">&nbsp;</td>
