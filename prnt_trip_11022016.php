...
<?php echo $team_leader?>
            ...
            <td width="12%"  rowspan="4"  style="text-align:left" ><div class="css-vertical-text_inner"><?php echo $group_name?></div></td>
 ...
 $numofrows=mysqli_num_rows($sql);
  ...
  while($result= mysqli_fetch_array($sql)){
	...
	?></td>
            ...
            <td height="50" colspan="10" bgcolor="#fdfdfd" style="border-bottom:1px #C0C0C0 solid" ><?php echo 	$spreqs?></td>
