...
//			if ($row + 1 > 65536 or $column + 1 > 256) {
	 ...
	 */
	function printRowColHeaders($print = 1): void
	{
	 ...
	 */
	function setOutline($visible = true, $symbols_below = true, $symbols_right = true, $auto_style = false): void
	{
	 ...
	 * @return integer
	 */
	private function _writeLabelSst($row, $col, $str, $xfIndex): void
	{
		$record	= 0x00FD;				   // Record identifier
		$length	= 0x000A;				   // Bytes to follow
	 ...
	 */
	function insertBitmap($row, $col, $bitmap, $x = 0, $y = 0, $scale_x = 1, $scale_y = 1): void
	{
	 ...
	 */
	function _positionImage($col_start, $row_start, $x1, $y1, $width, $height): void
	{
