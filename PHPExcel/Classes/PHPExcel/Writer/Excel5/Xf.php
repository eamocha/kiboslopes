...
class PHPExcel_Writer_Excel5_Xf
{
	...
	*/
	 ...
	 */
	function setBottomColor($colorIndex): void
	{
	 ...
	 * @param int $colorIndex Color index
	 */
	function setTopColor($colorIndex): void
	{
	 ...
	 * @param int $colorIndex Color index
	 */
	function setLeftColor($colorIndex): void
	{
	 ...
	 * @param int $colorIndex Color index
	 */
	function setRightColor($colorIndex): void
	{
	 ...
	 * @param int $colorIndex Color index
	 */
	function setDiagColor($colorIndex): void
	{
	 ...
	 * @param int $colorIndex Color index
	 */
	function setFgColor($colorIndex): void
	{
	 ...
	 * @param int $colorIndex Color index
	 */
	function setBgColor($colorIndex): void
	{
	 ...
	 */
	function setNumberFormatIndex($numberFormatIndex): void
	{
