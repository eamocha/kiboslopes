...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeTitle(PHPExcel_Chart_Title $title = null, $objWriter): void
	{
		if (is_null($title)) {
			return;
		}
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeLegend(PHPExcel_Chart_Legend $legend = null, $objWriter): void
	{
		if (is_null($legend)) {
			return;
		}
	...
	private function _writePlotArea(PHPExcel_Chart_PlotArea $plotArea,
									...
									$objWriter,
									PHPExcel_Worksheet $pSheet): void
	{
		if (is_null($plotArea)) {
			return;
		}
...
//					} while ($id1 == $id2);
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeCatAx($objWriter, PHPExcel_Chart_PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries): void
	{
...
//										$objWriter->writeAttribute('xml:space', 'preserve');
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeValAx($objWriter, PHPExcel_Chart_PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries): void
	{
...
//										$objWriter->writeAttribute('xml:space', 'preserve');
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeLayout(PHPExcel_Chart_Layout $layout = NULL, $objWriter): void
	{
