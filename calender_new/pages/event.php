...
if ($mode == 'edit' and !$refresh) { //show/edit event
	...
	$des = preg_replace_callback($rxULink,function($m){ return $m[1].($m[2]!=$m[3]?" [".$m[3]."] ":" ");},$desHtml);
	$remks = preg_replace_callback($rxULink,function($m){ return $m[1].($m[2]!=$m[3]?" [".$m[3]."] ":" ");},$remksHtml);
